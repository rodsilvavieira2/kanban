...
export function CreateTask() {
  ...
  const [columnId, setColumnId] = useState(stateColumnId || (columns.length > 0 ? columns[0].id : ''));
      ...
      <div className="create-task-content">
        <div className="create-task-page-header">
          ...
          <div className="header-actions">
            ...
            <button className="btn-primary" onClick={handleCreate} disabled={!title || !columnId}>
              Create Task
            </button>
          </div>
        </div>
